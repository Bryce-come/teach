<template>
  <div v-loading="loading" class="usage-analysis">
    <div style="display:flex;justify-content:center;margin-bottom:15px">
      ...
      <el-button :type="timeButton? 'primary':''" style="width:200px;margin-left:5px" @click="showTime()">操作台运行时间分析
      </el-button>
    </div>
    ...
    <div v-show="timeButton">
      <el-form :inline="true">
        <el-form-item label="操作台名称:" label-width="100px">
          ...
          <lkt-select :list="stationNameList" value-key="name" option-value-key="id" v-model="deviceName"
                      placeholder="请选择操作台名称"/>
        </el-form-item>
        <el-form-item label="时间范围:" label-width="100px">
  ...
  export default createComponent({
    ...
    setup() {
      ...
      const queryNum = async () => {
        ...
        (chart.value as any).yAxis.name = '课时';
      };
