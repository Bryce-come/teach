<template>
  <div class="flex" style="justify-content:space-around;align-items:center;" v-loading="loading">
      <div>
        ...
        <div style="color:#26b229;margin-left:0.5vw;margin-top:-1vh;font-size:12px">{{'运行中:'+state.workingNum}}</div>
      ...
      <div>
        ...
        <div style="color:#ff4949;margin-left:1vw;margin-top:-1vh;font-size:12px">{{'故障:'+state.emergencyNum}}</div>
      ...
      <div>
        ...
        <div style="color:#E6E6FA;margin-left:1vw;margin-top:-1vh;font-size:12px">{{'关机:'+state.offlineNum}}</div>
