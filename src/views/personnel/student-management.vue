    ...
    <kit-dialog-simple
      ...
      width="700px">
        ...
        <el-form v-if="modal.studentInfo" ref="form" :model="modal.studentInfo" label-width="120px" label-position="left" style="width: 580px;margin: 0 auto">
          <el-form-item label="登录用户名：" prop="username" :rules="[{ required: true, message: '请输入登录用户名'},{ pattern: /^[0-9a-zA-z-_]+$/g, message: '限字母、数字、下划线、减号'}]">
...
export default {
  ...
  return{
    ...
    removeClass: useConfirm(`确认删除?`, useLoading(loading, removeClass)),
