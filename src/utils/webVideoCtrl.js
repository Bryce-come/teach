      ...
      var t = function () {
          ...
          GetSelectWndInfo = function (e) {
            ...
            if (re()) {
              ...
              var r = f.loadXML2(e);
              // console.log("37", r);
              if (r.getElementsByTagName("SelectWnd").length > 0) {
                u = parseInt(r.getElementsByTagName("SelectWnd")[0].textContent, 10),
                null === C && U();
                var t = [];
                t.push("<RealPlayInfo>"),
              ...
              } else if (r.getElementsByTagName("DoubleClickWnd").length > 0) {
                var s = parseInt(r.getElementsByTagName("DoubleClickWnd")[0].textContent, 10);
                l = "0" === r.getElementsByTagName("IsFullScreen")[0].textContent,
          ...
          var _ = function () {
            ...
            V = function (e) {
              m.I_GetDeviceInfo(e.szIP, {
                success: function (t) {
                  e.szDeviceType = t.getElementsByTagName("deviceType")[0].textContent
                }
              }),
                m.I_GetAnalogChannelInfo(e.szIP, {
                  success: function (t) {
                    e.iAnalogChannelNum = t.getElementsByTagName("VideoInputChannel").length
                  }
                }),
                m.I_GetAudioInfo(e.szIP, {
                  success: function (t) {
                    var r = t.getElementsByTagName("audioCompressionType");
                    if (r.length > 0) {
                      var s = r[0].textContent,
                        o = 0;
                      "G.711ulaw" == s ? o = 1 : "G.711alaw" == s ? o = 2 : "G.726" == s ? o = 3 : "MP2L2" == s || "MPEL2" == s ? o = 4 : "G.722.1" == s ? o = 0 : "AAC" == s ? o = 5 : "PCM" == s && (o = 6),
                        e.iAudioType = o
                    }
                    "" !== t.getElementsByTagName("audioBitRate")[0].textContent ? e.m_iAudioBitRate = 1e3 * parseInt(t.getElementsByTagName("audioBitRate")[0].textContent, 10) : e.m_iAudioBitRate = 0,
                      "" !== t.getElementsByTagName("audioSamplingRate")[0].textContent ? e.m_iAudioSamplingRate = 1e3 * parseInt(t.getElementsByTagName("audioSamplingRate")[0].textContent, 10) : e.m_iAudioSamplingRate = 0
                  }
                })
            },
            j = function (e) {
              e.bSupportWebsocket = !1,
                ...
                e.oProtocolInc.getSystemCapa(e, {
                  success: function (t) {
                    var r = t.getElementsByTagName("NetworkCap")[0].getElementsByTagName("isSupportWebsocket");
                    r.length > 0 && (e.bSupportWebsocket = "true" === t.getElementsByTagName("NetworkCap")[0].getElementsByTagName("isSupportWebsocket")[0].textContent),
                      r = t.getElementsByTagName("RacmCap")[0].getElementsByTagName("isSupportMainAndSubRecord"),
                    r.length > 0 && (e.bSupportSubStreamPlayback = "true" === t.getElementsByTagName("RacmCap")[0].getElementsByTagName("isSupportMainAndSubRecord")[0].textContent)
                  }
                })
            },
            O = function () {
            ...
            K = function (e) {
              ...
              return e.oProtocolInc.getPortInfo(e, {
                async: !1,
                success: function (e) {
                  var o = e.getElementsByTagName("AdminAccessProtocol");
                  t = 554;
                  for (var i = 0,
                         a = o.length; a > i; i++) "rtsp" === o[i].getElementsByTagName("protocol")[0].textContent.toLowerCase() && (t = parseInt(o[i].getElementsByTagName("portNo")[0].textContent, 10)),
                  "http" === o[i].getElementsByTagName("protocol")[0].textContent.toLowerCase() && (r = parseInt(o[i].getElementsByTagName("portNo")[0].textContent, 10)),
                  "dev_manage" === o[i].getElementsByTagName("protocol")[0].textContent.toLowerCase() && (s = parseInt(o[i].getElementsByTagName("portNo")[0].textContent, 10))
                },
                error: function () {
                  t = -1,
                    r = -1,
            ...
            Y = function (e) {
              ...
              return e.oProtocolInc.getUPnPPortStatus(e, {
                async: !1,
                success: function (e) {
                  for (var o = e.getElementsByTagName("portStatus"), i = 0, a = o.length; a > i; i++) "rtsp" == o[i].getElementsByTagName("internalPort")[0].textContent.toLowerCase() && (t = parseInt(o[i].getElementsByTagName("externalPort")[0].textContent, 10)),
                  "http" == o[i].getElementsByTagName("internalPort")[0].textContent.toLowerCase() && (r = parseInt(o[i].getElementsByTagName("externalPort")[0].textContent, 10)),
                  "admin" == o[i].getElementsByTagName("internalPort")[0].textContent.toLowerCase() && (s = parseInt(o[i].getElementsByTagName("externalPort")[0].textContent, 10))
                },
                error: function () {
                  t = -1,
                    r = -1,
            ...
            Q = function (e) {
              ...
              return e.oProtocolInc.getNetworkBond(e, {
                async: !1,
                success: function (r) {
                  "true" == r.getElementsByTagName("enabled")[0].textContent ? t.push({
                    ipv4: r.getElementsByTagName("ipAddress")[0].textContent,
                    ipv6: r.getElementsByTagName("ipv6Address")[0].textContent
                  }) : e.oProtocolInc.getNetworkInterface(e, {
                    async: !1,
                    success: function (e) {
                      for (var r = e.getElementsByTagName("NetworkInterface"), s = 0, o = r.length; o > s; s++) {
                        t.push({
                          ipv4: e.getElementsByTagName("ipAddress")[0].textContent,
                          ipv6: e.getElementsByTagName("ipv6Address")[0].textContent
                        });
                        break
                      }
                    },
            ...
            ee = function (e) {
              ...
              return e.oProtocolInc.getPPPoEStatus(e, {
                async: !1,
                success: function (e) {
                  t = e.getElementsByTagName("ipAddress").length > 0 ? !0 : e.getElementsByTagName("ipv6Address").length > 0
                },
                error: function () {
                  t = !1
                }
              ...
              e.oStreamCapa.bObtained || e.oProtocolInc instanceof le && e.oProtocolInc.getSDKCapa(e, {
                ...
                success: function (t) {
                  ...
                  e.oStreamCapa.bObtained = !0,
                    e.oStreamCapa.bSupportShttpPlay = "true" === t.getElementsByTagName("isSupportHttpPlay")[0].textContent,
                    e.oStreamCapa.bSupportShttpPlayback = "true" === t.getElementsByTagName("isSupportHttpPlayback")[0].textContent,
                    e.oStreamCapa.bSupportShttpsPlay = "true" === t.getElementsByTagName("isSupportHttpsPlay")[0].textContent,
                    e.oStreamCapa.bSupportShttpsPlayback = "true" === t.getElementsByTagName("isSupportHttpsPlayback")[0].textContent,
                    e.oStreamCapa.bSupportShttpPlaybackTransCode = "true" === t.getElementsByTagName("isSupportHttpTransCodePlayback")[0].textContent,
                    e.oStreamCapa.bSupportShttpsPlaybackTransCode = "true" === t.getElementsByTagName("isSupportHttpsTransCodePlayback")[0].textContent,
                  t.getElementsByTagName("ipChanBase").length > 0 && (e.oStreamCapa.iIpChanBase = parseInt(t.getElementsByTagName("ipChanBase")[0].textContent, 10))
                },
                error: function () {
                  e.oStreamCapa.bObtained = !0
                }
          ...
          this.I_InitPlugin = function (t, n, o) {
            ...
            this.I_GetLocalCfg = function () {
              ...
              return C = f.loadXML(t),
                ...
                r.push("<ProtocolType>" + C.getElementsByTagName("ProtocolType")[0].textContent + "</ProtocolType>"),
                r.push("<PackgeSize>" + C.getElementsByTagName("PackgeSize")[0].textContent + "</PackgeSize>"),
                r.push("<PlayWndType>" + C.getElementsByTagName("PlayWndType")[0].textContent + "</PlayWndType>"),
                r.push("<BuffNumberType>" + C.getElementsByTagName("BuffNumberType")[0].textContent + "</BuffNumberType>"),
                r.push("<RecordPath>" + C.getElementsByTagName("RecordPath")[0].textContent + "</RecordPath>"),
                r.push("<CapturePath>" + C.getElementsByTagName("CapturePath")[0].textContent + "</CapturePath>"),
                r.push("<PlaybackFilePath>" + C.getElementsByTagName("PlaybackFilePath")[0].textContent + "</PlaybackFilePath>"),
                r.push("<PlaybackPicPath>" + C.getElementsByTagName("PlaybackPicPath")[0].textContent + "</PlaybackPicPath>"),
                r.push("<DeviceCapturePath>" + C.getElementsByTagName("DeviceCapturePath")[0].textContent + "</DeviceCapturePath>"),
                r.push("<DownloadPath>" + C.getElementsByTagName("DownloadPath")[0].textContent + "</DownloadPath>"),
                r.push("<IVSMode>" + C.getElementsByTagName("IVSMode")[0].textContent + "</IVSMode>"),
                r.push("<CaptureFileFormat>" + C.getElementsByTagName("CaptureFileFormat")[0].textContent + "</CaptureFileFormat>"),
                r.push("</LocalConfigInfo>"),
                e = f.loadXML(r.join(""))
            },
            this.I_SetLocalCfg = function (e) {
              ...
              return C.getElementsByTagName("ProtocolType")[0].childNodes[0].nodeValue = t.getElementsByTagName("ProtocolType")[0].textContent,
                C.getElementsByTagName("PackgeSize")[0].childNodes[0].nodeValue = t.getElementsByTagName("PackgeSize")[0].textContent,
                C.getElementsByTagName("PlayWndType")[0].childNodes[0].nodeValue = t.getElementsByTagName("PlayWndType")[0].textContent,
                C.getElementsByTagName("BuffNumberType")[0].childNodes[0].nodeValue = t.getElementsByTagName("BuffNumberType")[0].textContent,
                C.getElementsByTagName("RecordPath")[0].childNodes[0].nodeValue = t.getElementsByTagName("RecordPath")[0].textContent,
                C.getElementsByTagName("CapturePath")[0].childNodes[0].nodeValue = t.getElementsByTagName("CapturePath")[0].textContent,
                C.getElementsByTagName("PlaybackFilePath")[0].childNodes[0].nodeValue = t.getElementsByTagName("PlaybackFilePath")[0].textContent,
                C.getElementsByTagName("DeviceCapturePath")[0].childNodes[0].nodeValue = t.getElementsByTagName("DeviceCapturePath")[0].textContent,
                C.getElementsByTagName("PlaybackPicPath")[0].childNodes[0].nodeValue = t.getElementsByTagName("PlaybackPicPath")[0].textContent,
                C.getElementsByTagName("DownloadPath")[0].childNodes[0].nodeValue = t.getElementsByTagName("DownloadPath")[0].textContent,
                C.getElementsByTagName("IVSMode")[0].childNodes[0].nodeValue = t.getElementsByTagName("IVSMode")[0].textContent,
                C.getElementsByTagName("CaptureFileFormat")[0].childNodes[0].nodeValue = t.getElementsByTagName("CaptureFileFormat")[0].textContent,
          ...
          this.I_Login = function (t, r, s, o, i, a) {
                  ...
                  f.extend(u, {
                    success: function (o) {
                      ...
                      i.szIP = t,
                        ...
                        i.szAuth = o.getElementsByTagName("sessionID")[0].textContent,
                        i.iDeviceProtocol = p,
                        i.oProtocolInc = l,
                        d.push(i),
                        _("使用%s协议登录成功", p),
            ...
            this.I_StartRealPlay = function (e, t) {
              ...
              if (f.extend(P, t), -1 != r) {
                ...
                if (re()) {
                  ...
                  var I = parseInt(C.getElementsByTagName("ProtocolType") [0].textContent, 10);
            ...
            this.I_StartPlayback = function (e, t) {
              ...
              if (f.extend(p, t), -1 != r) {
                ...
                if (re()) {
                  ...
                  var h = parseInt(C.getElementsByTagName("ProtocolType")[0].textContent, 10);
            ...
            this.I_SetSnapPolygonInfo = function (e, t) {
              ...
              // console.log("921", r);
              r = f.loadXML(C),
                s = r.getElementsByTagName("SnapPolygon");

              var S = s.length,
                v = [];
              for (o = 0, i = s.length; i > o; o++) a = s[o],
                v.push(a.getElementsByTagName("id")[0].textContent);
              var y = v.join(",");
              // console.log("927");
              if (y = "," + y + ",", r = f.loadXML(t), s = r.getElementsByTagName("SnapPolygon"), S + s.length > 32) return -3;
              for (o = 0, i = s.length; i > o; o++) {
                if (a = s[o], u = a.getElementsByTagName("id")[0].textContent, !f.isInt(u)) return -2;
                if (l = parseInt(u, 10), 1 > l || l > 32) return -2;
                if (y.indexOf("," + u + ",") > -1) return -4;
                if (d = a.getElementsByTagName("tips")[0].textContent, d.length > 32) return -2;
                if (h = "true" === a.getElementsByTagName("isClosed")[0].textContent, !h) {
                  if (p = a.getElementsByTagName("MinClosed")[0].textContent, !f.isInt(p)) return -2;
                  if (P = parseInt(p, 10), 4 > P || P > 17) return -2;
                  if (I = a.getElementsByTagName("PointNumMax")[0].textContent, !f.isInt(I)) return -2;
          ...
          le.prototype.CGI = {
              ...
              f.extend(o, t),
                f.extend(o, {
                  success: function (e) {
                    var r = [];
                    r.push("<DeviceInfo>"),
                      r.push("<deviceName>" + f.escape(e.getElementsByTagName("deviceName")[0].textContent) + "</deviceName>"),
                      r.push("<deviceID>" + e.getElementsByTagName("deviceID")[0].textContent + "</deviceID>"),
                      r.push("<deviceType>" + e.getElementsByTagName("deviceType")[0].textContent + "</deviceType>"),
                      r.push("<model>" + e.getElementsByTagName("model")[0].textContent + "</model>"),
                      r.push("<serialNumber>" + e.getElementsByTagName("serialNumber")[0].textContent + "</serialNumber>"),
                      r.push("<macAddress>" + e.getElementsByTagName("macAddress")[0].textContent + "</macAddress>"),
                      r.push("<firmwareVersion>" + e.getElementsByTagName("firmwareVersion")[0].textContent + "</firmwareVersion>"),
                      r.push("<firmwareReleasedDate>" + e.getElementsByTagName("firmwareReleasedDate")[0].textContent + "</firmwareReleasedDate>"),
                      r.push("<encoderVersion>" + e.getElementsByTagName("encoderVersion")[0].textContent + "</encoderVersion>"),
                      r.push("<encoderReleasedDate>" + e.getElementsByTagName("encoderReleasedDate")[0].textContent + "</encoderReleasedDate>"),
                      r.push("</DeviceInfo>"),
                      e = f.loadXML(r.join("")),
                    t.success && t.success(e),
              ...
              f.extend(o, t),
                f.extend(o, {
                  success: function (e) {
                    ...
                    for (var s = e.getElementsByTagName("VideoInputChannel"), o = 0, i = s.length; i > o; o++) {
                      var a = s[o];
                      r.push("<VideoInputChannel>"),
                        r.push("<id>" + a.getElementsByTagName("id")[0].textContent + "</id>"),
                        r.push("<inputPort>" + a.getElementsByTagName("inputPort")[0].textContent + "</inputPort>"),
                        r.push("<name>" + f.escape(a.getElementsByTagName("name")[0].textContent) + "</name>"),
                        r.push("<videoFormat>" + a.getElementsByTagName("videoFormat")[0].textContent + "</videoFormat>"),
                        r.push("</VideoInputChannel>")
                    }
                    // console.log("1171", r);
                    r.push("</VideoInputChannelList>"),
              ...
              f.extend(o, t),
                f.extend(o, {
                  success: function (e) {
                    ...
                    for (var s = e.getElementsByTagName("InputProxyChannel"), o = 0, i = s.length; i > o; o++) {
                      var a = s[o];
            ...
            le.prototype.getDigitalChannelInfo = function (e, t) {
              ...
              if (this.getDigitalChannel(e, {
                ...
                success: function (e) {
                  r = e;
                  for (var t = r.getElementsByTagName("InputProxyChannel"), o = 0, i = t.length; i > o; o++) {
                    var a = t[o],
                      c = a.getElementsByTagName("id")[0].textContent,
                      u = a.getElementsByTagName("name")[0].textContent;
                    s[c] = u
                  }
                },
                error: function (e, n) {
                ...
                f.extend(a, t),
                  f.extend(a, {
                    success: function (e) {
                      ...
                      for (var o = e.getElementsByTagName("InputProxyChannelStatus"), i = 0, a = o.length; a > i; i++) {
                        var c = o[i],
                          u = c.getElementsByTagName("id")[0].textContent;
                        r.push("<InputProxyChannelStatus>"),
                          r.push("<id>" + u + "</id>"),
                          r.push("<sourceInputPortDescriptor>"),
                          r.push("<proxyProtocol>" + c.getElementsByTagName("proxyProtocol")[0].textContent + "</proxyProtocol>"),
                          r.push("<addressingFormatType>" + c.getElementsByTagName("addressingFormatType")[0].textContent + "</addressingFormatType>"),
                          r.push("<ipAddress>" + c.getElementsByTagName("ipAddress")[0].textContent + "</ipAddress>"),
                          r.push("<managePortNo>" + c.getElementsByTagName("managePortNo")[0].textContent + "</managePortNo>"),
                          r.push("<srcInputPort>" + c.getElementsByTagName("srcInputPort")[0].textContent + "</srcInputPort>"),
                          r.push("<userName>" + f.escape(c.getElementsByTagName("userName")[0].textContent) + "</userName>"),
                          r.push("<streamType>" + c.getElementsByTagName("streamType")[0].textContent + "</streamType>"),
                          r.push("<online>" + c.getElementsByTagName("online")[0].textContent + "</online>"),
            ...
            le.prototype.ptzControl = function (e, t, n, r) {
              var s = n.iChannelID,
                o = "";
              n.bPTZAuto && this.ptzAutoControl(e, n, {
                iPTZSpeed: 0
              }),
                ...
                f.extend(d, {
                  success: function (e) {
                    ...
                    t.push("<CMSearchResult>"),
                      t.push("<responseStatus>" + e.getElementsByTagName("responseStatus")[0].textContent + "</responseStatus>"),
                      t.push("<responseStatusStrg>" + e.getElementsByTagName("responseStatusStrg")[0].textContent + "</responseStatusStrg>"),
                      t.push("<numOfMatches>" + e.getElementsByTagName("numOfMatches")[0].textContent + "</numOfMatches>"),
                      t.push("<matchList>");
                    for (var s = e.getElementsByTagName("searchMatchItem"), o = 0, i = s.length; i > o; o++) {
                      var a = s[o];
                      t.push("<searchMatchItem>"),
                        t.push("<trackID>" + a.getElementsByTagName("trackID")[0].textContent + "</trackID>"),
                        t.push("<startTime>" + a.getElementsByTagName("startTime")[0].textContent + "</startTime>"),
                        t.push("<endTime>" + a.getElementsByTagName("endTime")[0].textContent + "</endTime>"),
                        t.push("<playbackURI>" + f.escape(a.getElementsByTagName("playbackURI")[0].textContent) + "</playbackURI>"),
                        t.push("<metadataDescriptor>" + a.getElementsByTagName("metadataDescriptor")[0].textContent.split("/")[1] + "</metadataDescriptor>"),
                        t.push("</searchMatchItem>")
                    }
                    t.push("</matchList>"),
                      t.push("</CMSearchResult>"),
            ...
            le.prototype.set3DZoom = function (e, t, r, s) {
              ...
              var a = f.loadXML(r),
                c = parseInt(a.getElementsByTagName("StartPoint")[0].getElementsByTagName("positionX")[0].textContent, 10),
                u = parseInt(a.getElementsByTagName("StartPoint")[0].getElementsByTagName("positionY")[0].textContent, 10),
                l = parseInt(a.getElementsByTagName("EndPoint")[0].getElementsByTagName("positionX")[0].textContent, 10),
                d = parseInt(a.getElementsByTagName("EndPoint")[0].getElementsByTagName("positionY")[0].textContent, 10),
            ...
            le.prototype.sessionLogin = function (e, t, r, s, o, i, a) {
              ...
              var u = E(this.CGI.sessionLogin, c, e, r),
                l = i.getElementsByTagName("sessionID")[0].textContent,
                d = i.getElementsByTagName("challenge")[0].textContent,
                p = parseInt(i.getElementsByTagName("iterations")[0].textContent, 10),
                P = !1,
                h = "";
              i.getElementsByTagName("isIrreversible").length > 0 && (P = "true" === i.getElementsByTagName("isIrreversible")[0].textContent, h = i.getElementsByTagName("salt")[0].textContent);
              var I = "";
              if (P) {
                I = f.sha256(s + h + o),
                  I = f.sha256(I + d);
          ...
          de.prototype.CGI = {
            ...
            de.prototype.login = function (e, t, r, s) {
              ...
              f.extend(c, s),
                f.extend(c, {
                  success: function (e) {
                    "200" == e.getElementsByTagName("statusValue")[0].textContent ? s.success && s.success(e) : s.error && s.error(401, e)
                  },
                  error: function (e, t) {
                    s.error && s.error(e, t)
                  }
                ...
                f.extend(o, {
                  success: function (e) {
                    ...
                    r.push("<DeviceInfo>"),
                      r.push("<deviceName>" + f.escape(e.getElementsByTagName("deviceName")[0].textContent) + "</deviceName>"),
                      r.push("<deviceID>" + e.getElementsByTagName("deviceID")[0].textContent + "</deviceID>"),
                      r.push("<deviceType>" + e.getElementsByTagName("deviceDescription")[0].textContent + "</deviceType>"),
                      r.push("<model>" + e.getElementsByTagName("model")[0].textContent + "</model>"),
                      r.push("<serialNumber>" + e.getElementsByTagName("serialNumber")[0].textContent + "</serialNumber>"),
                      r.push("<macAddress>" + e.getElementsByTagName("macAddress")[0].textContent + "</macAddress>"),
                      r.push("<firmwareVersion>" + e.getElementsByTagName("firmwareVersion")[0].textContent + "</firmwareVersion>"),
                      r.push("<firmwareReleasedDate>" + e.getElementsByTagName("firmwareReleasedDate")[0].textContent + "</firmwareReleasedDate>"),
                      r.push("<encoderVersion>" + e.getElementsByTagName("logicVersion")[0].textContent + "</encoderVersion>"),
                      r.push("<encoderReleasedDate>" + e.getElementsByTagName("logicReleasedDate")[0].textContent + "</encoderReleasedDate>"),
                      r.push("</DeviceInfo>"),
                      e = f.loadXML(r.join("")),
                    t.success && t.success(e),
                    t.mysuccess && t.mysuccess(r.join(""))
              ...
              f.extend(o, t),
                f.extend(o, {
                  success: function (e) {
                    var r = [];
                    r.push("<InputProxyChannelList>");
                    for (var s = e.getElementsByTagName("DynVideoInputChannel"), o = 0, i = s.length; i > o; o++) {
                      var a = s[o];
                      r.push("<InputProxyChannel>"),
                        r.push("<id>" + a.getElementsByTagName("id")[0].textContent + "</id>"),
                        r.push("<name>" + f.escape(a.getElementsByTagName("name")[0].textContent) + "</name>"),
                ...
                f.extend(a, t),
                  f.extend(a, {
                    success: function (e) {
                      var r = [];
                      r.push("<InputProxyChannelStatusList>");
                      for (var o = e.getElementsByTagName("DynVideoInputChannelStatus"), i = 0, a = o.length; a > i; i++) {
                        var c = o[i],
                          u = c.getElementsByTagName("id")[0].textContent;
                        r.push("<InputProxyChannelStatus>"),
                          r.push("<id>" + u + "</id>"),
                          r.push("<sourceInputPortDescriptor>"),
                          r.push("<proxyProtocol>" + c.getElementsByTagName("adminProtocol")[0].textContent + "</proxyProtocol>"),
                          r.push("<addressingFormatType>" + c.getElementsByTagName("addressingFormatType")[0].textContent + "</addressingFormatType>"),
                          r.push("<ipAddress>" + c.getElementsByTagName("ipAddress")[0].textContent + "</ipAddress>"),
                          r.push("<managePortNo>" + c.getElementsByTagName("adminPortNo")[0].textContent + "</managePortNo>"),
                          r.push("<srcInputPort>" + c.getElementsByTagName("srcInputPort")[0].textContent + "</srcInputPort>"),
                          r.push("<userName>" + f.escape(c.getElementsByTagName("userName")[0].textContent) + "</userName>"),
                          r.push("<streamType>" + c.getElementsByTagName("streamType")[0].textContent + "</streamType>"),
                          r.push("<online>" + c.getElementsByTagName("online")[0].textContent + "</online>"),
              ...
              f.extend(o, t),
                f.extend(o, {
                  success: function (r) {
                    ...
                    for (var o = r.getElementsByTagName("AdminAccessProtocol"), i = 0, a = o.length; a > i; i++) {
                      o[i];
                      s.push("<AdminAccessProtocol>"),
                        s.push("<id>" + r.getElementsByTagName("id")[0].textContent + "</id>"),
                        s.push("<enabled>" + r.getElementsByTagName("enabled")[0].textContent + "</enabled>"),
                        s.push("<protocol>" + r.getElementsByTagName("protocol")[0].textContent.toUpperCase() + "</protocol>"),
                        s.push("<portNo>" + r.getElementsByTagName("portNo")[0].textContent + "</portNo>"),
                        s.push("</AdminAccessProtocol>")
                    }
                    I.getStreamChannels(e, {
                      async: !1,
                      success: function (r) {
                        if (r.getElementsByTagName("rtspPortNo").length > 0) {
                          var o = parseInt(r.getElementsByTagName("rtspPortNo")[0].textContent, 10);
                          s.push("<AdminAccessProtocol>"),
                            s.push("<id>4</id>"),
                          ...
                          async: !1,
                          success: function (e) {
                            if (e.getElementsByTagName("rtspPortNo").length > 0) {
                              var r = parseInt(e.getElementsByTagName("rtspPortNo")[0].textContent, 10);
                              s.push("<AdminAccessProtocol>"),
                                s.push("<id>4</id>"),
                                s.push("<enabled>true</enabled>"),
                                s.push("<protocol>RTSP</protocol>"),
                  ...
                  error: function () {
                    ...
                    r.push("<AdminAccessProtocolList>"),
                      I.getStreamChannels(e, {
                        async: !1,
                        success: function (s) {
                          if (s.getElementsByTagName("rtspPortNo").length > 0) {
                            var o = parseInt(s.getElementsByTagName("rtspPortNo")[0].textContent, 10);
                            ...
                            success: function (e) {
                              if (e.getElementsByTagName("rtspPortNo").length > 0) {
                                var s = parseInt(e.getElementsByTagName("rtspPortNo")[0].textContent, 10);
                                r.push("<AdminAccessProtocol>"),
                                  r.push("<id>4</id>"),
                                  r.push("<enabled>true</enabled>"),
                                  r.push("<protocol>RTSP</protocol>"),
